...
class Calcmod(loader.Module): 
    strings = {"name": "Extended calc", "err_int": "Only integral values", "_cls_doc": " Calculator with many functions. Only .e is better", "err_txt": "<b>[cl]</b> Error in a case"}
    strings_ru = {"err_int": "Только целые значения", "_cls_doc": " Калькулятор со множеством функций. Лучше только .e", "err_txt": "<b>[cl]</b> Ошибка в примере"}

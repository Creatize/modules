...
class Calcmod(loader.Module): 
    strings = {"name": "Extended calc", "err": "Only integral values", "_cls_doc": " Calculator with many functions. Only .e is better"}
    strings_ru = {"err": "Только целые значения", "_cls_doc": " Калькулятор со множеством функций. Лучше только .e"}
